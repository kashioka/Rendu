...
**[Download Rendu.dmg](https://github.com/kashioka/Rendu/releases/latest/download/Rendu_0.9.0_aarch64.dmg)** — open and drag to Applications.
...
**[Download Rendu installer (.exe)](https://github.com/kashioka/Rendu/releases/latest/download/Rendu_0.9.0_x64-setup.exe)** — run the installer.

### Linux

**[Download .deb](https://github.com/kashioka/Rendu/releases/latest/download/Rendu_0.9.0_amd64.deb)** — install on Debian/Ubuntu/Mint with:

```bash
sudo apt install ./Rendu_0.9.0_amd64.deb
```

For Fedora/RHEL: **[Download .rpm](https://github.com/kashioka/Rendu/releases/latest/download/Rendu-0.9.0-1.x86_64.rpm)** —

```bash
sudo dnf install ./Rendu-0.9.0-1.x86_64.rpm
```

For other distributions (openSUSE, Arch, NixOS, etc.): **[Download AppImage](https://github.com/kashioka/Rendu/releases/latest/download/Rendu_0.9.0_amd64.AppImage)** — make it executable and run:
